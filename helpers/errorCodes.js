...
var errorCodes = {
	...
	USERNAMES: {
		...
		USERNAME_LIKE_ADDRESS: {
			message: "Username cannot be a potential SimoCoin address. TX ID: %s",
			args: ["id"]
		},
	...
	ACCOUNTS: {
		...
		INVALID_ADDRESS: {
			message: "%s is an invalid address. Please provide a valid SimoCoin address",
			args: ["address"]
		}
	},
	DELEGATES: {
		...
		USERNAME_LIKE_ADDRESS: {
			message: "Delegate names cannot be a potential SimoCoin address",
			args: ["asset.delegate.username"]
		},
	...
	TRANSACTIONS: {
		...
		INVALID_AMOUNT: {
			message: "Invalid transaction amount. You cannot send %i XCR. Please try again",
			args: ["amount"]
		},
